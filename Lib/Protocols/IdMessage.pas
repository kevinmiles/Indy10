...
begin
  ...
  // P.Nehez, 1 Sep 2017 - allowing to pass empty Name field into "From"
  FLastGeneratedHeaders.Values['From'] := EncodeAddress(FromList, HeaderEncoding, ISOCharSet); {do not localize}
